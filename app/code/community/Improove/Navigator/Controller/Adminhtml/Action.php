...
/**
 * Main Controller class for the Improove_Navigator module
 *
 * @author      Henrik Hedelund <henrik@improove.se>
 */
class Improove_Navigator_Controller_Adminhtml_Action extends Mage_Adminhtml_Controller_Action
{
    /**
     * Initializes and returns the full tree structure
     *
     * @return Improove_Navigator_Model_Tree
     */
