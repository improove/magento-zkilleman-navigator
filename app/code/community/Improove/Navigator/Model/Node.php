...
class Improove_Navigator_Model_Node extends Mage_Core_Model_Abstract
{
    protected $_parent;
    protected $_children;
    ...
    public function setParent(Improove_Navigator_Model_Node &$node)
    {
        $this->_parent = $node;
    }
    ...
    public function appendChild(Improove_Navigator_Model_Node &$node)
    {
        $node->setParent($this);
        $this->_children[] = $node;
    }

    public function insertChild(Improove_Navigator_Model_Node &$node,
            Improove_Navigator_Model_Node &$prevSibling = null)
    {
        $node->setParent($this);
        $pos = 0;
        if($prevSibling) {
    ...
    public function unsetChild(Improove_Navigator_Model_Node &$node)
    {
    ...
    /**
     *
     * @return Improove_Navigator_Model_Node_Content_Type
     */
